!function (module) {
    ...
    module = module || {};
    module.init = init;
    module.setPublicationType = setPublicationType;

    function init(context) {
        initForm();
        setPublicationType(context);
        bindEvents();
    }

    function setPublicationType(pub_type_id) {
        __pub_type_id = pub_type_id;
        refreshList();
    }
                ...
                "确定": function () {
                    ...
                    if ($("#publication-editor-form").valid()) { // will trigger form validation
                        ...
                        ajaxFileUpload("publication-attach-form .file-uploading-anim", "di-Attachment-Pub").then(function () {
                            ...
                            _publication.Type = { ID: __pub_type_id };
...
} (Application.Modules["PublicationManager"]);